      ...
      issues = [
        ...
        %{
          ...
          "user" => %{
            ...
            "gravatar_id" => "",
            "html_url" => "https://github.com/zoranbosnjak",
            "id" => 9_718_081,
            "login" => "zoranbosnjak",
            ...
            "type" => "User",
            "url" => "https://api.github.com/users/zoranbosnjak"
          }
        },
        %{
          "assignee" => nil,
          ...
          "user" => %{
            ...
            "gravatar_id" => "",
            "html_url" => "https://github.com/wohanley",
            "id" => 1_322_287,
            "login" => "wohanley",
            ...
            "type" => "User",
            "url" => "https://api.github.com/users/wohanley"
          }
        }
      ]
