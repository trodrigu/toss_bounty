defmodule TossBountyWeb.SellableReposTest do
  ...
  describe "call/2" do
    ...
    test "when there are zero repos with stargazers" do
      ...
      SellableRepos.MockReposGrabber.insert_repo(%{ "name" => "Barter", "stargazers_count" => 0, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } })
    ...
    test "when there is one repo with more than zero stargazers" do
      ...
      SellableRepos.MockReposGrabber.insert_repo(%{ "name" => "toss_bounty", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } })
      result = SellableRepos.call(user)
    ...
    test "when there are ten repos with more than zero stargazers" do
      ...
      repos =
        [
          %{ "name" => "awesome_repo_1", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_2", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_3", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_4", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_5", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_6", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_7", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_8", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_9", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
          %{ "name" => "awesome_repo_10", "stargazers_count" => 3, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } },
        ]
    ...
    test "when there is one repo with between 20 to 40 stargazers returns score of 1" do
      SellableRepos.MockReposGrabber.clear
      user = with {:ok, user} <- Repo.insert!(%User{email: "test@example.com"}), do: user
      SellableRepos.MockReposGrabber.insert_repo(%{ "name" => "toss_bounty", "stargazers_count" => 21, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } })
      result = SellableRepos.call(user)
    ...
    test "when there is one repo with between 40 to 60 stargazers returns score of 2" do
      SellableRepos.MockReposGrabber.clear
      user = with {:ok, user} <- Repo.insert!(%User{email: "test@example.com"}), do: user
      SellableRepos.MockReposGrabber.insert_repo(%{ "name" => "toss_bounty", "stargazers_count" => 41, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } })
      result = SellableRepos.call(user)
    ...
    test "when there is one repo with between 60 to 80 stargazers returns score of 3" do
      SellableRepos.MockReposGrabber.clear
      user = with {:ok, user} <- Repo.insert!(%User{email: "test@example.com"}), do: user
      SellableRepos.MockReposGrabber.insert_repo(%{ "name" => "toss_bounty", "stargazers_count" => 61, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } })
      result = SellableRepos.call(user)
    ...
    test "when there is one repo with between 80 to 100 stargazers returns score of 4" do
      SellableRepos.MockReposGrabber.clear
      user = with {:ok, user} <- Repo.insert!(%User{email: "test@example.com"}), do: user
      SellableRepos.MockReposGrabber.insert_repo(%{ "name" => "toss_bounty", "stargazers_count" => 81, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } })
      result = SellableRepos.call(user)
    ...
    test "when there is one repo with over 100 stargazers returns score of 5" do
      SellableRepos.MockReposGrabber.clear
      user = with {:ok, user} <- Repo.insert!(%User{email: "test@example.com"}), do: user
      SellableRepos.MockReposGrabber.insert_repo(%{ "name" => "toss_bounty", "stargazers_count" => 101, "owner" => %{ "login" => "smcfarlane", "avatar" => "avatar-source" } })
      result = SellableRepos.call(user)
