defmodule TossBounty.SellableReposTest do
  ...
  alias TossBounty.SellableRepos.MockRepoGrabber
  ...
  describe "call/2" do
    ...
    test "when there are zero repos with issues" do
      ...
      SellableRepos.MockRepoGrabber.clear
      SellableRepos.MockRepoGrabber.insert_repo(%{ "name": "Barter", "open_issues_count": 0 })
    ...
    test "when there is one repo with more than zero issues" do
      ...
      SellableRepos.MockRepoGrabber.insert_repo(%{ "name": "toss_bounty", "open_issues_count": 3 })
      result = SellableRepos.call(user)
    ...
    test "when there are ten repos with more than zero issues" do
      ...
      SellableRepos.MockRepoGrabber.insert_repos repos
      result = SellableRepos.call(user)
