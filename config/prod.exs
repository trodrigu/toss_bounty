...
config :toss_bounty, TossBounty.Endpoint,
  ...
  https: [port: 443,
          otp_app: :toss_bounty,
          keyfile: "/etc/letsencrypt/live/api.tossbounty.com.com/privkey.pem",
          cacertfile: "/etc/letsencrypt/live/api.tossbounty.com.com/chain.pem",
          certfile: "/etc/letsencrypt/live/api.tossbounty.com.com/cert.pem"],
  server: true,
  root: ".",
